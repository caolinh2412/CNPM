namespace CoffeeShopManagementSystem
{
    partial class SignInForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            fg_Pass.Font = new Font("Arial Rounded MT Bold", 10.8F, FontStyle.Underline, GraphicsUnit.Point, 0);
            fg_Pass.ForeColor = Color.FromArgb(63, 29, 18);
            fg_Pass.Location = new Point(61, 503);
            fg_Pass.Name = "fg_Pass";
            fg_Pass.Size = new Size(171, 21);
            fg_Pass.TabIndex = 43;
            fg_Pass.Text = "Forgot Password?";
            fg_Pass.Click += fg_Pass_Click;
            // 
            // SignInForm
            // 
